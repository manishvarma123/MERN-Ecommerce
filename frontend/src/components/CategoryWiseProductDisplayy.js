...
const CategoryWiseProductDisplayy = ({ category, heading }) => {
    ...
    return (
        <div className='max-w-[1450px] mx-auto px-4 my-6 relative'>
            ...
            <div className='grid grid-cols-[repeat(auto-fit,minmax(300px,300px))] justify-between md:gap-6 overflow-x-scroll scrollbar-none duration-1000'>
                
                {
                    ...
                    (
                        data.map((product, index) => {
                            return (
                                <Link to={"/product/"+product?._id} className='w-full min-w-[280px] md:min-w-[280px] max-w-[300px] md:max-w-[310px] bg-white rounded-sm border border-slate-300  shadow-md' onClick={scrollTop}>
...
export default CategoryWiseProductDisplayy