...
const UploadProduct = ({ onClose,fetchData }) => {
  ...
  return (
    <div className='fixed w-full h-full bg-slate-200/70 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
      <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
        ...
        <form className='grid px-4 pb-8 gap-2 overflow-y-auto h-full' onSubmit={handleSubmit}>
          ...
          <button className='px-3 py-2 bg-red-600 text-white font-semibold mb-10 hover:bg-red-700'>Upload Product</button>
