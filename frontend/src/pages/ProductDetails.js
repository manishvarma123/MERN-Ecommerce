...
import CategoryWiseProductDisplayy from '../components/CategoryWiseProductDisplayy';
...
const ProductDetails = () => {
  ...
  return (
    <div className='max-w-[1450px] mx-auto p-4'>
            ...
            {/* product zoom */}
            {
              zoomImage && (
                <div className='hidden lg:block absolute min-w-[500px] min-h-[400px] overflow-hidden bg-slate-200 p-1 -right-[510px] top-0'>
                  <div
                    className='w-full h-full overflow-hidden min-h-[390px] min-w-[390px] mix-blend-multiply scale-125'
                    style={{
          ...
          loading ? (
            <div className='grid gap-1 w-full'>
              ...
              <div className='flex items-center gap-2 text-2xl lg:text-3xl font-medium my-1 h-6 lg:h-8 animate-pulse'>
                <p className='text-red-600 bg-slate-200 w-full h-6'></p>
                <p className='text-slate-500 line-through bg-slate-200 w-full h-6'></p>
              </div>
      ...
      {
        data.category && (
          <CategoryWiseProductDisplayy category={data?.category} heading={"Recommended Product"}/>
        )
      }
